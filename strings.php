	...
	$array = array(
		...
		array(
        	...
        	"content" => "We are pleased to announce that The Honourable Hugh D Segal, C.M. has accepted the position of Honorary Patron of Lunch By George. Senator Segal is a long time champion of the cause of the poor, the alienated and the disenfranchised, and we are delighted to have his support."
                ...
                array(
                "header" => "Annual General Meeting",
                "content" => "Our Annual General Meeting was held on Monday July 15th at in Lunch By George, 129 Wellington Street, Kingston. Those in attendance approved the Board decisions of 2012, and the audited financial statements. They also approved various proposals for activities in the coming year."
        ),
                array(
                "header" => "Fundraising Dinner",
                "content" => "Thanks to all who came and bid in the silent auction, or bought mugs. We raised $2700 on Friday and all enjoyed ourselves. It is never too late to contribute if you were busy or forgot!"
        ),
                array(
                "header" => "Anglican Churches in Ontario Diocese",
                "content" => "have again shown their generosity by donating $1802 from their special ordination service in May. Thank you all for thinking of the needy."
        ),
                array(
